...
class FoodRVAdapter (
    ...
    private val food: MutableList<FoodEntity>) : RecyclerView.Adapter<FoodRVAdapter.ViewHolder>() {

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(context).inflate(R.layout.food_rv_item, parent, false)
